...
# Récupérer et afficher le nombre total de règles stockées sur le serveur
total_stored = data.get('num_stored', 0)
print(f"Nombre total de règles stockées sur le serveur : {total_stored}")
